...
public class Debtors extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{Class.forName("com.mysql.jdbc.Driver");
            ...
            PreparedStatement ps=con.prepareStatement("insert into Debtor (email,date,amount,source,returns,note) values(?,?,?,?,?,?)");
            ps.setString(1,mail);
            ...
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this,"Debtor Saved!");
            con.close();
        }
        catch(Exception e){
